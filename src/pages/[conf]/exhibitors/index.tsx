...
const DIRECTORY_CONFIG = getOrganizationDirectoryConfig("exhibitors")!;

export default function ExhibitorsPage({ conf, activePageId }: OrganizationDirectoryPageProps) {
  return (
    <DirectoryPage
      conf={conf}
...
export const getStaticProps: GetStaticProps<OrganizationDirectoryPageProps> = async (ctx) => {
  ...
  return { props: { conf: result.conf, activePageId: "exhibitors" } };
};
