...
const menuCardIconClassName =
  "flex h-10 w-10 shrink-0 items-center justify-center rounded-[1rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.07),rgba(255,255,255,0.025))] text-slate-400 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition-all duration-200 group-hover/item:border-[var(--dc34-accent-primary)]/32 group-hover/item:bg-[var(--dc34-accent-primary)]/12 group-hover/item:text-[var(--dc34-accent-secondary)] group-focus-within/item:border-[var(--dc34-accent-primary)]/32 group-focus-within/item:bg-[var(--dc34-accent-primary)]/12 group-focus-within/item:text-[var(--dc34-accent-secondary)] sm:h-11 sm:w-11";
