...
const DIRECTORY_CONFIG = getOrganizationDirectoryConfig("vendors")!;

export default function VendorsPage({ conf, activePageId }: OrganizationDirectoryPageProps) {
  return (
    <DirectoryPage
      conf={conf}
...
export const getStaticProps: GetStaticProps<OrganizationDirectoryPageProps> = async (ctx) => {
  ...
  return { props: { conf: result.conf, activePageId: "vendors" } };
};
